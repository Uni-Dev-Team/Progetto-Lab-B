...
import cittadini.util.Regex;
import cittadini.util.RegistrationHandler;
import cittadini.util.SceneManager;
...
public class FXMLRegistrazioneController1 implements Initializable {
    ...
    void onClickAvanti(ActionEvent event) {
        ...
        // regex per controllare se il codice fiscale rispetta lo standard
