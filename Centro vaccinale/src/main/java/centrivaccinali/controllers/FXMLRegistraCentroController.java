...
import centrivaccinali.communication.Client;
import centrivaccinali.enumerators.*;
import centrivaccinali.util.JSONReader;
import centrivaccinali.util.Regex;
import centrivaccinali.util.SceneManager;
...
public class FXMLRegistraCentroController implements Initializable {
    ...
    void onClickRegistraCentro(ActionEvent event) {
        ...
        // ottiene le informazioni necessarie dalla GUI
                ...
                if(Regex.check(nomeCentro, "^[a-zA-Z0-9 ]*$")) {
                    if(Regex.check(nomeStrada, "^[a-zA-Z0-9 ]*$")) {
                        if(Regex.check(numeroAbitazione, "^[A-Za-z0-9\\/]*$")) {
                            ...
                            // Gestisci codice centro vaccinale
                        } else {
                            errorMessage.setVisible(true);
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        // inserimento qualificatore indirizzo in combobox
        ...
        // inserimetno tipologia centro vaccinale in combobox
